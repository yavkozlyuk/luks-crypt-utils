...
extern const char *opt_new_key_file;
...
extern const char *opt_new_header_device;
...
public:
    ...
    static int action_addKey(void);

    static int action_removeKey(void);

    static int action_changeKey(void);

    static int action_killSlot(void);

    static int action_UUID(void);
